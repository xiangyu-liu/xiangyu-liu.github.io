...
My research focuses on the foundational aspects of <u>*reinforcement learning (RL)*</u>, particularly on <u>*game-theoretical and multi-agent*</u> problems, <u>*partially observable*</u> settings, and applications in <u>*adversarially robust RL*</u>. 

More recently, I have expanded my research to explore <u>*large language model (LLM) agent interactions*</u>, leveraging techniques from <u>*game theory*</u> and <u>*online learning*</u>.
...
<li style="margin-bottom: 10px;">Talk at the 2024 INFORMS Optimization Society Conference (IOS 2024) on <a href="https://openreview.net/pdf?id=6dnHrArK48" target="_blank">partially observable multi-agent RL</a>, Houston, Texas, 2024</li> 
